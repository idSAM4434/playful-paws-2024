...
function expandImage(imgElement) {
    ...
    overlayVideo.style.display = 'none'; // Hide video if previously shown
...
function expandVideo(videoElement) {
    ...
    overlayImg.style.display = 'none'; // Hide image if previously shown
    overlayVideoSource.src = videoElement.querySelector('source').src;
    overlayVideo.load(); // Reload video to start from beginning
...
function closeOverlay() {
    ...
    overlayVideo.pause(); // Pause the video when closing overlay
}
